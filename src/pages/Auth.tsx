...
export default function Auth() {
  ...
  // Redirect if already authenticated and verified based on role
  useEffect(() => {
    if (user && profile?.is_verified) {
      console.log('User is authenticated and verified, redirecting based on role:', profile.role);
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // The auth hook will handle the redirect based on verification status
      // If not verified, user will be redirected to verify page
      // If verified, user will be redirected based on role
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="text-2xl text-center">Farm Store</CardTitle>
